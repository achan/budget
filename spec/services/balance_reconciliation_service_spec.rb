    ...
    context "when one account has enough to pay off the rest" do
      ...
      it "finds the account with the most money and pays off the other accounts" do
        expect(subject).to eq [
          Payment.new(from_account: "Joint", to_account: "Condo", amount_in_cents: 200000 / 24.0, frequency: Frequency::SEMI_MONTHLY),
          Payment.new(from_account: "Joint", to_account: "Savings", amount_in_cents: 3057464 / 24.0, frequency: Frequency::SEMI_MONTHLY)
        ]
      end
    end
  end
